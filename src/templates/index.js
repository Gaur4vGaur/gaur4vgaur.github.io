...
class BlogIndex extends React.Component {
    render() {
        ...
        const { limit, skip, isFirstPage, isLastPage, currentPage, totalPages } = this.props.pageContext;
        console.log(limit, skip, isFirstPage, isLastPage, currentPage, totalPages)
